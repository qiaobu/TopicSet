 ...
 * 图A: 手指选中一条边的情况：LEFT,TOP,RIGHT,BOTTOM
 * 图B: 手指选中两条边的情况：此时手指位于裁剪框的四个角度的某一个：LEFT and TOP, TOP and RIGHT, RIGHT and BOTTOM, BOTTOM and RIGHT
 * 图C: 手指在裁剪框的中间区域，此时移动手指进行的是平移操作
 */
