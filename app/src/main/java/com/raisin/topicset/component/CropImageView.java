package com.raisin.topicset.component;
...
import com.raisin.topicset.component.ImageView.util.CatchEdgeUtil;
import com.raisin.topicset.component.ImageView.util.UIUtil;
...
public class CropImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    // 判断手指位置是否处于缩放裁剪框位置的范围：
    // 是:当手指移动的时候裁剪框会相应的变化大小
    // 否:手指移动的时候就是拖动裁剪框使之随着手指移动
